...
namespace SmallScaleInc.TopDownPixelCharactersPack1
{
    public class AnimationController : MonoBehaviour
    {
        ...
        void HandleMovement()
        {
            ...
            isRunningBackwards = Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.W);
...
public void TriggerSpecialAbility1Animation()
{
    ...
    // Safely set 'isSpecialAbility1' to true to initiate the special ability animation
    if (AnimatorHasParameter(animator, "isSpecialAbility1"))
    {
        animator.SetBool("isSpecialAbility1", true);
    }

    // Determine the current direction and safely trigger the appropriate special ability animation
    TrySetAnimatorBool("SpecialAbility1North", animator.GetBool("isNorth"));
    TrySetAnimatorBool("SpecialAbility1South", animator.GetBool("isSouth"));
    TrySetAnimatorBool("SpecialAbility1East", animator.GetBool("isEast"));
    TrySetAnimatorBool("SpecialAbility1West", animator.GetBool("isWest"));
    TrySetAnimatorBool("SpecialAbility1NorthEast", animator.GetBool("isNorthEast"));
    TrySetAnimatorBool("SpecialAbility1NorthWest", animator.GetBool("isNorthWest"));
    TrySetAnimatorBool("SpecialAbility1SouthEast", animator.GetBool("isSouthEast"));
    TrySetAnimatorBool("SpecialAbility1SouthWest", animator.GetBool("isSouthWest"));
...
IEnumerator ResetSpecialAbility1Parameters()
{
    ...
    // Safely reset all special ability parameters to false
    TrySetAnimatorBool("isSpecialAbility1", false);
    TrySetAnimatorBool("SpecialAbility1North", false);
    TrySetAnimatorBool("SpecialAbility1South", false);
    TrySetAnimatorBool("SpecialAbility1East", false);
    TrySetAnimatorBool("SpecialAbility1West", false);
    TrySetAnimatorBool("SpecialAbility1NorthEast", false);
    TrySetAnimatorBool("SpecialAbility1NorthWest", false);
    TrySetAnimatorBool("SpecialAbility1SouthEast", false);
    TrySetAnimatorBool("SpecialAbility1SouthWest", false);
...
public void TriggerSpecialAbility2Animation()
{
    ...
    // Safely set 'isSpecialAbility2' to true to initiate the special ability animation
    if (AnimatorHasParameter(animator, "isSpecialAbility2"))
    {
        animator.SetBool("isSpecialAbility2", true);
    }

    // Determine the current direction and safely trigger the appropriate special ability animation
    TrySetAnimatorBool("SpecialAbility2North", animator.GetBool("isNorth"));
    TrySetAnimatorBool("SpecialAbility2South", animator.GetBool("isSouth"));
    TrySetAnimatorBool("SpecialAbility2East", animator.GetBool("isEast"));
    TrySetAnimatorBool("SpecialAbility2West", animator.GetBool("isWest"));
    TrySetAnimatorBool("SpecialAbility2NorthEast", animator.GetBool("isNorthEast"));
    TrySetAnimatorBool("SpecialAbility2NorthWest", animator.GetBool("isNorthWest"));
    TrySetAnimatorBool("SpecialAbility2SouthEast", animator.GetBool("isSouthEast"));
    TrySetAnimatorBool("SpecialAbility2SouthWest", animator.GetBool("isSouthWest"));
...
IEnumerator ResetSpecialAbility2Parameters()
{
    ...
    // Safely reset all special ability parameters to false
    TrySetAnimatorBool("isSpecialAbility2", false);
    TrySetAnimatorBool("SpecialAbility2North", false);
    TrySetAnimatorBool("SpecialAbility2South", false);
    TrySetAnimatorBool("SpecialAbility2East", false);
    TrySetAnimatorBool("SpecialAbility2West", false);
    TrySetAnimatorBool("SpecialAbility2NorthEast", false);
    TrySetAnimatorBool("SpecialAbility2NorthWest", false);
    TrySetAnimatorBool("SpecialAbility2SouthEast", false);
    TrySetAnimatorBool("SpecialAbility2SouthWest", false);
